...
const App = () => {
  ...
  socket?.on("OpponentFound", function (data) {
    ...
    Swal.close(); // Close the waiting popup when opponent is found
  });
  ...
  return (
    <div className="main-div">
      ...
      {!finishedState && opponentName && (
        <h2>You are playing against :  <div id="namee">{opponentName}</div></h2>
      )}
...
//       // Close if opponent name is received
//       if (opponentName) {
//         Swal.close();
//       }
